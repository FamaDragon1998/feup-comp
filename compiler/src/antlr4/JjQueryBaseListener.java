...
/**
 * This class provides an empty implementation of {@link JjQueryListener}, which
 * can be extended to create a listener which only needs to handle a subset of
 * the available methods.
 */
public class JjQueryBaseListener implements JjQueryListener {
	/**
	 * {@inheritDoc}
	 *
	 * <p>
	 ...
	 */
	@Override
	public void enterJQueryBlock(@NotNull JjQueryParser.JQueryBlockContext ctx) {
	}
	 ...
	 */
	@Override
	public void exitJQueryBlock(@NotNull JjQueryParser.JQueryBlockContext ctx) {
	}
	 ...
	 */
	@Override
	public void enterMain(@NotNull JjQueryParser.MainContext ctx) {
	}
	 ...
	 */
	@Override
	public void exitMain(@NotNull JjQueryParser.MainContext ctx) {
	}
